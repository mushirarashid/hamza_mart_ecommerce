...
var x = setInterval(function() {
  ...
  // Display the result in the element with id="demo"
  document.getElementById("demo_2").innerHTML = hours + "h "
  ;
...
var x = setInterval(function() {
  ...
  // Display the result in the element with id="demo"
  document.getElementById("demo_5").innerHTML = days + "d "
  ;
...
var x = setInterval(function() {
  ...
  // Display the result in the element with id="demo"
  document.getElementById("demo_6").innerHTML = hours + "h "
  ;
